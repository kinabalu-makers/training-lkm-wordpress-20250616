...
RUN "$env:windir\system32\inetsrv\appcmd.exe" set config -section:system.webServer/fastCgi /+"[fullPath='$env:PHP_DIR\php-cgi.exe',arguments='',maxInstances='4',instanceMaxRequests='10000',activityTimeout='600',requestTimeout='600',queueLength='1000']" /commit:apphost; \
